...
(function (root, factory) {
    ...
    function WarpSpeed(targetId,config){
        ...
        this.BACKGROUND_COLOR=config.backgroundColor===undefined?"#F4F4F4":config.backgroundColor;	
        var canvas=document.getElementById(this.targetId);
        canvas.width=1; canvas.height=1;
        this.STAR_COLOR=config.starColor==undefined?"#464646":config.starColor;
